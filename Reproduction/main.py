...
def main(args):
    ...
    f1_bin, auc_score, auprc_score = trainer_object.train_and_evaluate(train_dataset, test_dataset, labels)

    return (f1_bin, auc_score, auprc_score)
...
if __name__ == '__main__':
    ...
    f1_bin, auc_score, auprc_score = main(args)

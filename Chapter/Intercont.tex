...
That means, as long as the product of the positive pair ot the summed producted of the negative pair ist not smaller than Tau = 0.01, the both numinator and denominator are 
...
The loss is taken as the outlier score y(x)

...
First the model needs an anchor. Thats the data instance wich is researched.   
A positive pair is created by random data augmentation of the anchor. 
The two points are about the same thing, so the should be placed closely in the embedding space.
The dissimiliar example is something completly different of anchor and will be placed further apart from the positive instance.
The more different the samples are, the better the prediction will be.
By adding more negative pairs, the model is been enabled to learn more distinctive features of the such dissimiliar instances.
Resulting in better predictions and avoiding over fitting.
Increasing the ability of generalization and robustness.

...
Unfortunately they did not provide in their reproduction packagae any code to test their results.
...
Similiar to the InterCont Method, I put in the normal data into the training dataset and the normal plus abnormal data into the testing dataset.
The seperation takes place between the line 16 to 19.


After that the training is performed by using an 5-fold cross validation approach.
That means that the training dataset is cut again into training and testing witha 80/20 split.

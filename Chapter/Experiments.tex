...
Here she displays the dataset at its current form, but writes that she uses it as the following author  \citep{rayana2016less}, she is the boss of the ODDS repository
She writes that it is from the UCI Machine Learning Repository but I think there it is not edited into the final form
Cites the source ater that \citep{aggarwal2015theoretical}
Mentions Ann-Throid Dataset of UCI repository \citep{keller2012hics}
I think the answer to it is the Schiffmann et al. paper
originally it was collected in 1987 from the garavan institute eg. Quinlan
\todo{add: the way it took to make this dataset - gemini}
...
All 6 dimensions are numerical features and include 5 different types of hormone whose absence or presence could indicate a disease in wich the thyroid plays a crucial role.

...
The Minimum Covariance Determinant is a outlier-robust statistical outlier detection method.
...
The algorithms was effective but computationally complex.
Therefore a more efficient algorithm was published in 1999 by \citet{rousseeuw1999fast}
First I will explain the Minimum Covariance Determinant (MCD) is constructed.
Afterwards I will transition to the FAST-MCD algorithm, which I will use in my experiments.
...
The goal of MCD is to find in a given set of data a subset $H$ of $h$ \todo{which onw is right? h or n?} observations in $p$ variables, that minimizes the subsets determinant covariance matrix.

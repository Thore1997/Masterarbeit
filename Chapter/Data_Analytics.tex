...
\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{Images/.pdf}
    \caption{Basic values of the unprocessed Thyroid Dataset}
\end{figure}
\textcolor{red}{Central tendencies}
This diagram is showing a boxplot per feature in the dataset.
...
Instances, that are coloured in red are instances, that are outliers in the multivariate sence

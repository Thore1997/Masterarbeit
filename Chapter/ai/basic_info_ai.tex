...
Nevertheless, the network is trained on 50\% labled normal data and tested on the other 50\% of data that includes all labeled outliers.
For this study, the same epxerimental setup will be implemented for the benchmark methods.

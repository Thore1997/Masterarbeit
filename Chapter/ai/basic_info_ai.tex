...
\begin{sloppypar} Machine learning paradigms serve as overarching frameworks for interpreting data \citep[p. 4]{sarker2021machine}, providing the foundational logic for how algorithms process information. \end{sloppypar}
...
Activation functions \citep{rasamoelina2020review} are essential for introducing non-linearity into the model, allowing it to approximate complex functions. 

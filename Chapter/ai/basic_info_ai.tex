...
In the proceding thesis, this will be named semi-supervised.   
...
During training, the network's output is evaluated against the ground truth using a loss functions \citep{terven2025comprehensive}. 

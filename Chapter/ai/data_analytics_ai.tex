...
The geometric structure, also called manifold, in the $p$-dimensional space can be highly complex globally, but locally follow a simple Euclidean structure.
...
Supporting evidence for this stability is provided in the appendix by running the alglorithmy with $n_{\text{neighbors}} \in \{10, 20\}$and $min_{dist} = 0.5$. 
To ensure that all attributes contribute proportionally to the manifold construction, the data is normalized using the Robust transformation.

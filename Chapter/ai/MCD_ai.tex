...
The objective of the MCD is to identify a subset $H$ containing $h$ observations (where $h$ is typically between $\frac{n+p+1}{2}$ and $n$) \todo{right place?} that yields the minimum possible covariance matrix determinant.

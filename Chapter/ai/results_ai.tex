...
To ensure a rigorous assessment of these findings, a ANOVA and subsequently Welch's t-test are applied to the results. \todo{add more details}
...
\todo{where should this go? - maybe appendix?}
...
However, the Wilcoxon signed-rank test is not applicable to the present experimental results, as the evaluation is restricted to a single dataset. \todo{weak argument, why am I not deploying?}

...
Although more recent versions of the Python interpreter exist, Python 3.12 was selected as the foundational language to ensure full compatibility with the required library ecosystem, as several critical packages had not yet been updated for newer releases. 
...
To introduce stochasticity into the permutation process, the authors utilized the PyTorch function torch.randperm().
...
\subsubsection*{k-NN}
The k-NN algorithm was implemented in knn\_benchmark.py by using the PyOD library. 
...
Especially the F1-Score provided by SciKitLearn was used to estimate this metric. 

...
\textcolor{red}
{   There are three general concepts of machine learning. 
    ...
    It learns by comparing its predictions to the correct labels and minimizes the error.
    ...
    Hyperparamatic tuning is required to mitigate 
    ...
    Moreover it requires careful selection of tuning algorithms, as different semi-supervised methods have varying effectiveness based on the data. (Gemini)
    }
...
Afterwards compute the Mahalanobis Distance and sort them from smallest to largest. 
First you hav to create an initial subsets $H1$ 
...
The encoder network is typically a deep neural network architecture.
The network learns to extract and encode high-level representations from the augmented instances, facilitating the discrimination 
between similar and dissimilar instances in the subsequent steps. (https://encord.com/blog/guide-to-contrastive-learning/)
}
\textcolor{red} { 
Projection Network:
